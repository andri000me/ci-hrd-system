...
<head>
  ...
  <title>Edit Kelompok Produk - Dewanstudio Power Management</title>
...
data-open="click" data-menu="horizontal-menu" data-col="2-columns">
  ...
  <div class="app-content container center-layout mt-2">
    ...
    <div>
      ...
      <h1 class="text-center" style="padding:40px 0 40px 0;"><b>EDIT KELOMPOK PRODUK</b></h1>
      ...
      <div class="content-header row">
        ...
        <a href="<?=base_url()?>kelompok_produk">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-12 pb-xl-1 py-xl-1">
                            ...
                            <h5 class="pb-xl-1 py-xl-1">Product Group Name</h5>
                              ...
                              <input type="text" id="projectinput1" class="form-control" placeholder="Product Group Name" value="<?=$row->nama_kelompok?>" name="name">
