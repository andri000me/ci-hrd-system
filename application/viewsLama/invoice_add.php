  ...
  <div class="app-content container center-layout mt-2">
    ...
    <div class="content-wrapper">
		...
		<div>
			...
			<h1 class="text-center" style="padding:40px 0 40px 0;"><b>INVOICE</b></h1>
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                        	...
                        	<div class="col-md-6 pb-xl-1 py-xl-1">
                        	  ...
                        	  <h5 class="pb-xl-1 py-xl-1">Client</h5>

	                            <select name="client" class="form-control">
                               <option value="">--SELECT CLIENT--</option>
                               <?php foreach($client as $value=>$isi){ ?>
                                <option value="<?=$isi['id']?>"><?=$isi['nama_client']?> (<?=$isi['surname_client']?>)</option>
                               <?php } ?> 
                              </select>
                          ...
                          <div class="col-md-6 pb-xl-1 py-xl-1">
                            ...
                            <h5 class="pb-xl-1 py-xl-1">Type</h5>

                              <select name="type" class="form-control">
                               <option value="">--SELECT TYPE--</option>
                               <option value="13">Penawaran</option>
                               <option value="25">Tagihan</option>
                              </select>
