...
data-open="click" data-menu="horizontal-menu" data-col="content-detached-left-sidebar">
  ...
  <?php $kpnnipush = kpnpush($this->session->userdata("user_id")); ?> 

  <?php $now = date_now_ymd(true); ?>

  <?php $tglskrg = date_utc_ymd($now) ?>
  ...
  if($this->session->userdata("rule")=='1'){
    ...
    { 
      ...
      echo "
        <div class='modal fade bd-example-modal-lg' id='modalBelomAbsen' style='display: none;' aria-hidden='true'>
                     ...
                     <!--  <div class="col-md-2">
                      ...
                      <div class="col-md-5">
                        <div class="col-md-12 pb-xl-1 py-xl-1">
                            <input type="text" id="projectinput1" class="form-control" placeholder="<?php echo $info->name; ?>" name="fname" disabled="">
                        </div>
                          <div class="col-md-12 pb-xl-1 py-xl-1">
