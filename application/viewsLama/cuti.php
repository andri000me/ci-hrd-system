          ...
          <div id="recent-transactions" class="col-xl-4 col-lg-6 col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <h5 class="p-xl-1">
                  <!-- <b>TOTAL CUTI : <?=$jumlahtotalcuti?><br> -->
                  <b>TOTAL CUTI : <?= jumlah_cuti_y(user_id()) ?> <small>(Rejected tidak terhitung)</small> <br>
                  
                  SISA CUTI : <?=$jatahcuti->cuti?></b>
                ...
                <div class="pl-xl-1 pr-xl-1 px-xl-1">
                 ...
                 <p class="m-xl-0">
                  ...
                  <?php if(!empty($getcuti['tanggal_akhir'])){ ?>
                   ...
                   <?php echo date('d-m-Y', strtotime($getcuti['tanggal_mulai']));?> - <?php echo  date('d-m-Y', strtotime($getcuti['tanggal_akhir']));?> (<?php echo  $status ?>)

                   <?php }elseif (empty($getcuti['tanggal_akhir'])) {

                    echo ''.date('d-m-Y', strtotime($getcuti['tanggal_mulai'])).' ('.$status.')';
                ...
                <a class="btn btn-block btn-success " href="<?=base_url()?>cuti/add_jumlah_cuti?cuti=12">Add Jumlah Cuti</a>
                <?php } ?>
              </div>
