...
<head>
  ...
  <title>Add Kelompok Produk - Dewanstudio Power Management</title>
  ...
  <div class="app-content container center-layout mt-2">
    ...
    <div class="content-wrapper">
		...
		<div>
			...
			<h1 class="text-center" style="padding:40px 0 40px 0;"><b>ADD KELOMPOK PRODUK</b></h1>
                        ...
                        <div class="form-group row">
                        	...
                        	<div class="col-md-12 pb-xl-1 py-xl-1">
                        	  ...
                        	  <h5 class="pb-xl-1 py-xl-1">Product Group Name</h5>
	                            ...
	                            <input type="text" id="projectinput1" class="form-control" placeholder="Product Group Name" value="<?=set_value('name')?>" name="name">
