                ...
                <div class="card-content">
                  <form method="GET" enctype="multipart/form-data">
                    <div class="row card-body">
                      ...
                      <div class="col">
                        <a style="float: right;" href="<?=base_url()?>sakit">
                      ...
                      <table id="project-bugs-list" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
                        ...
                        <tbody>
                          ...
                          <?php
                            ...
                            $tanggalmulai = date('d-m-Y', strtotime($sakit['tanggal_mulai']));

                            $tanggalakhir = date('d-m-Y', strtotime($sakit['tanggal_akhir']));
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <h5><?=$njeh = (!empty($sakit['tanggal_akhir'])) ? $tanggalakhir:''?></h5>

                            </td>

							              <td>

                              <h5><a href="<?=base_url()?>clients/sakit/<?=$sakit['img']?>" target="_blank"><?=$sakit['img']?></a></h5>
