...
<head>
  ...
  <title>Kelompok Produk - Dewanstudio Power Management</title>
      ...
      <div class="content-header row">
        ...
        <div class="content-header-left col-md-12 col-12 mb-2">
          ...
          <div>
			...
			<h1 class="text-center" style="padding:40px 0 40px 0;"><b>KELOMPOK PRODUK</b></h1>
              ...
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <div class="heading-elements">
                    ...
                    <a href="<?=base_url()?>kelompok_produk/add"><button class="btn btn-primary btn-md"><i class="ft-plus white"></i> ADD KELOMPOK PRODUK</button></a>
                            ...
                            <td>
                              ...
                              <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                  ...
                                  <a href="<?=base_url()?>kelompok_produk/edit/<?=$isi['id'];?>" class="dropdown-item"><i class="ft-edit-2"></i> Edit</a>

                                  <a href="<?=base_url()?>kelompok_produk/delete/<?=$isi['id'];?>" class="dropdown-item"><i class="ft-trash"></i> Delete</a>
