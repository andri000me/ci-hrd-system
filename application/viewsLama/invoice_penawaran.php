  ...
  <div class="app-content container center-layout mt-2">
    ...
    <div class="content-wrapper">
		...
		<div>
			...
			<h1 class="text-center" style="padding:40px 0 40px 0;"><b>PENAWARAN</b></h1>
      ...
      <div class="content-header row">
        ...
        <div class="content-header-right col-md-6 col-12">
          ...
          <div class="btn-group float-md-right pb-xl-2 my-1">
		  	...
		  	<a href="<?=base_url()?>invoice/penawaran_list">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="form form-horizontal">
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" class="form-control" name="nama" value="<?=$row[0]['penawaran_name']?>">
