...
class Reportproject extends MY_Controller {
...

    {
        ...
        elseif (empty($this->input->get('searchname')) && !empty($this->input->get('bulan')) && empty($this->input->get('tahun'))) {
            $searchname = array('ds_project.project_start' => '-'.$this->input->get('bulan').'-');       
        }

        // Pencarian Tahun
        elseif (empty($this->input->get('searchname')) && empty($this->input->get('bulan')) && !empty($this->input->get('tahun'))) {
            $searchname = array('ds_project.project_start' => $this->input->get('tahun').'-');       
        }

        // Pencarian Bulan dan Tahun
        elseif (empty($this->input->get('searchname')) && !empty($this->input->get('bulan')) && !empty($this->input->get('tahun'))) {
            $searchname = array('ds_project.project_start' => $this->input->get('tahun').'-'.$this->input->get('bulan').'-');
        }
        ...
        elseif (!empty($this->input->get('searchname')) && !empty($this->input->get('bulan')) && empty($this->input->get('tahun'))) {
            $searchname = array(
                ...
                'ds_project.project_start' => '-'.$this->input->get('bulan').'-'
            );        
        }
        ...
        elseif (!empty($this->input->get('searchname')) && empty($this->input->get('bulan')) && !empty($this->input->get('tahun'))) {
            $searchname = array(
                'ds_users.name' => $this->input->get('searchname'),
                'ds_project.project_start' => $this->input->get('tahun').'-'
            );        
        }
        ...
        elseif (!empty($this->input->get('searchname')) && !empty($this->input->get('bulan')) && !empty($this->input->get('tahun'))) {
            $searchname = array(
                'ds_users.name' => $this->input->get('searchname'),
                'ds_project.project_start' => $this->input->get('tahun').'-'.$this->input->get('bulan').'-'
            );        
        }

        elseif (!empty($this->input->get('searchproject'))) {
            $searchname = array('ds_project.project_name' => $this->input->get('searchproject'));        
        }
        ...
        $config['base_url'] = base_url(FALSE).'reportproject?searchname='.$this->input->get('searchname').'&bulan='.$this->input->get('bulan').'&tahun='.$this->input->get('tahun');
